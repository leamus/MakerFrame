...
```
game.loadmap(mapRID, userData, forceRepait=false)
```
...
`game.talk(role=null, msg='', interval=20, pretext='', keeptime=0, style=null, pauseGame=true, callback=true);`
...
`game.menu(title='', items=[], style={}, pauseGame=true, callback=true);`
...
`game.input(title='', pretext='', style={}, pauseGame=true, callback=true);`
