...
let data = (function() {
    ...
    let sysCommands = ({
                                ...
                                '多行普通信息': {
                                    command: ['显示多行普通信息', 'yield game.msg(GlobalLibraryJS.convertToHTML(%1, [" ", "\\n"]),%2,%3,%4,%5);', '', 0, true, 'red', 'white'],
                                    params: [
                                        ['*@信息', 'text', true, 2, [['文字', '变量', '地图变量', '全局变量', '引擎变量'], ['', '${变量1}', '${game.d["变量1"]}', '${game.gd["变量1"]}', 'game.cd["变量1"]']], 'green'],
                                        ['文字间隔', 'number', '60', 0, '60', 'blue'],
                                        ['预定义文字', 'string', '``', 0, '', 'lightblue'],
                                        ['持续时间', 'number', '1000', 0, '', 'lightblue'],
                                        ['显示效果', 'number', '3', 2, [['固定大小', '自适应高度', '自适应宽度', '自适应宽高'], ['0', '2', '1', '3'], '3'], 'lightblue'],
                                ...
                                '播放音乐': {
                                    ...
                                    params: [
                                        ['*@音乐名', 'string', true, 1, GameMakerGlobal.musicResourcePath(), 'green'],
                                    ],
                                },
                                '停止音乐': {
                                ...
                                '引擎变量': {
                                    ...
                                    params: [
                                        ['*@变量名', 'string', true, 2, [['引擎变量1', '引擎变量2', '引擎变量3', '引擎变量4', '引擎变量5', '引擎变量6', '引擎变量7', '引擎变量8', '引擎变量9'], ['引擎变量1', '引擎变量2', '引擎变量3', '引擎变量4', '引擎变量5', '引擎变量6', '引擎变量7', '引擎变量8', '引擎变量9']], 'green'],
                                    ],
                                },
                                '判断': {
                                    ...
                                    params: [
                                        ...
                                        ['@变量1', 'name', false, 2, [['变量1', '地图变量1', '全局变量1', '引擎变量1', '当前地图名', '金钱'], ['变量1', 'game.d["变量1"]', 'game.gd["变量1"]', 'game.cd["变量1"]', 'game.gd["$sys_map"].$name', 'game.money()']], 'green'],
                                        ['*@符号', 'name', true, 2, [['等于', '不等于', '大于', '小于', '大于等于', '小于等于'], ['===', '!==', '>', '<', '>=', '<=']], 'blue'],
                                ...
                                '简易运算': {
                                    ...
                                    params: [
                                        ...
                                        ['*@变量1', 'name', true, 2, [['地图变量（不用定义）', '全局变量（不用定义）', '引擎变量（不用定义）', '变量（第一次使用必须定义）'], ['game.d["变量1"]', 'game.gd["变量1"]', 'game.cd["变量1"]', '变量1']], 'green'],
                                        ['*@符号', 'name', true, 2, [['赋值', '加赋值', '减赋值', '乘赋值', '除赋值', '取余赋值', '位与赋值', '位或赋值', '左移赋值', '右移赋值'], ['=', '+=', '-=', '*=', '/=', '%=', '&=', '|=', '%=', '<<=', '>>='], '='], 'black'],
                                        ['@变量2', 'name', '', 2, [['值', '字符串', '变量2', '地图变量1', '全局变量2', '引擎变量2', '随机数'], [' ', '``', '变量2', 'game.d["变量2"]', 'game.gd["变量2"]', 'game.cd["变量2"]', 'game.rnd(m,n)']], 'green'],
                                        ['@运算符', 'name', '', 2, [['加', '减', '乘', '除', '取余', '位与', '位或', '左移位', '右移位'], ['+', '-', '*', '/', '%', '&', '|', '<<', '>>']], 'green'],
                                        ['@变量3', 'name', '', 2, [['值', '字符串', '变量3', '地图变量3', '全局变量3', '引擎变量3', '随机数'], [' ', '``', '变量3', 'game.d["变量3"]', 'game.gd["变量3"]', 'game.cd["变量3"]', 'game.rnd(m,n)']], 'green'],
                                    ],
                                },
                                '运算': {
                                    command: ['运算', '%1 %2 %3 %4 %5 %6', '运算', 0, true, 'red', 'white'],
    ...
    let sysCommandsTree = [
        ...
        ['变量', 'gold', ['当前地图名', '金钱', '战斗角色属性', '道具个数', '地图变量', '全局变量', '引擎变量']],
        //['媒体', 'gold', []],
