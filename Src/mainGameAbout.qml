...
<CENTER><B>关于</B></CENTER>
  ...
  鹰歌MakerFrame框架 是一款 使用Qt/QML/JAVA 构建的供二次开发的软件/游戏的制作及运行的开放式跨平台框架，它提供了跨平台、屏幕自适应、网络、热更新、数据库、文件管理、媒体播放器、浏览器内核等众多功能和扩展，可以用来开发很多种软件、游戏和引擎等；
  鹰歌RPG Maker引擎 是基于 鹰歌MakerFrame框架 开发的一套开放式 RPG/放置类 游戏制作引擎和运行环境，使用QML/JS编写，适用于开发游戏和插件，可使用视图编辑、代码或两者结合的方式；
