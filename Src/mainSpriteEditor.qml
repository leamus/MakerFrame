...
Item {
    ...
    ColumnLayout {
        ...
        L_List {
            ...
            onSg_removeClicked: {
                let dirUrl = $GameMakerGlobal.config.strProjectRootPath + $GameMakerGlobal.config.strCurrentProjectName + '/' + $GameMakerGlobal.config.strSpriteDirName + '/' + item;
        ...
        onLoaded: {
            ...
            /*if(item.$load) {
                try {
                    ...
                    //console.warn('[!mainSpriteEditor]', e);
                    //throw e;
                }
                finally {
                }
    ...
    QtObject {
        ...
        function refresh() {
            const list = $Frame.sl_dirList($GameMakerGlobal.config.strProjectRootPath + $GameMakerGlobal.config.strCurrentProjectName + '/' + $GameMakerGlobal.config.strSpriteDirName, [], 0x001 | 0x2000 | 0x4000, 0x00);
            //list.unshift('【新建特效】');
