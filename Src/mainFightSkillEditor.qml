...
Item {
    ...
    ColumnLayout {
        ...
        L_List {
            ...
            onSg_removeClicked: {
                const dirPath = $GameMakerGlobal.fightSkillPath(item);
                console.debug('[mainFightSkillEditor]删除：', dirPath, $Frame.sl_dirExists(dirPath), );
    ...
    QtObject {
        ...
        function openItem(item) {
            ...
            */
            ...
            /*
            let filePath = $GameMakerGlobal.fightSkillPath(item) + '/fight_skill.json';
