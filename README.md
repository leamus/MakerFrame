...
1. Windows版本：将 “鹰歌Maker_v1.0.rar”、 “Qt5.15.2_mingw81_32.rar” 和 “_L_Libs.rar” 解压到同一个文件夹（保证Updater.exe、运行.bat、_L_Libs文件夹 在同一目录下），双击“运行.bat”。
2. 安卓：安装运行即可。
3. 苹果IOS、MACOS、Linux相关：敬请期待适配。
4. 打开软件后，点击 鹰歌Maker 按钮，再点击 示例工程，请等待下载完毕后，点击 开始运行-》运行 就OK了。
5. 各平台软件都是热更新，大部分情况下无需额外操作（服务器带宽较慢，可能升级和下载时间会稍微长一点）。
